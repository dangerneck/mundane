...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Mundane__ = __webpack_require__(0);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }


var mundane = new __WEBPACK_IMPORTED_MODULE_0__Mundane__["default"](window, function (e) {
...
var appends = 0;
var lastAppend = Date.now();

var appendToBox = function appendToBox(e) {
  var text;
  ...
  var timeSpan = document.createElement('strong');
  var now = Date.now();
  var span = now - lastAppend;
  lastAppend = now;
  timeSpan.textContent = appends + ". || " + now + " || +" + span + "ms || ";
  appends += 1;
  var textSpan = document.createElement('span');
  textSpan.textContent = text;
  r.insertBefore(p, r.firstChild); // if (r.childElementCount > ){
...
mundane.observe('hello', appendToBox, function () {
  return appendToBox('before hello observed');
}, function () {
  return appendToBox('after hello observed');
}, function () {
  return mundane.sleep(350);
});
mundane.observe('click', appendToBox, function () {
  return appendToBox('before click observed');
}, function () {
  return appendToBox('500ms after click observed');
}, function () {
  return mundane.sleep(500);
});
var mevs = [mundane.make('hello', {
  data: 1000
}), mundane.make('hello', {
  data: 2000
}), mundane.make('hello', {
  ...
  data: 4000
})].forEach(function (mev, i) {
  mundane.occurIn(i * 1000, mev, function () {}, function () {});
});
var sequence = mundane.sequence([{
  afterMs: 4500,
  func: function func() {
    return appendToBox('HERE COMES A SEQUENCE ~~~');
  }
}, {
  afterMs: 500,
  func: function func() {
    return appendToBox('sequence step 1');
  }
}, {
  afterMs: 120,
  func: function func() {
    return appendToBox('sequence step 2');
  }
}, {
  afterMs: 250,
  func: function func() {
    return appendToBox('sequence step 3');
  }
}, {
  afterMs: 500,
  func: function func() {
    return appendToBox('sequence step 4');
  }
}, {
  afterMs: 600,
  func: function func() {
    return appendToBox('sequence step 5');
  }
}, {
  afterMs: 300,
  func: function func() {
    return appendToBox('sequence step 6');
  }
}], function (step) {
  return appendToBox("this step waited " + step.afterMs);
});
